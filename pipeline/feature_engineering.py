class FeatureEngineering:
    ...
    def drop_columns(self):
        ...
        columns_save = [f"{feature}_{i}" for feature in save for i in range(1, self.n_horses + 1)]
    ...
    def pick_top_horses(self):
        ...
        save_indexes = [index for index, result in self.target_int_mapping.items() if result <= self.limit_contestants]
